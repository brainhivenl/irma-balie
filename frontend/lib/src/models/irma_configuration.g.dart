...
Issuer _$IssuerFromJson(Map<String, dynamic> json) {
  return Issuer(
    ...
    name: TranslatedValue.fromJson(json['Name'] as Map<String, dynamic>),
    shortName:
        TranslatedValue.fromJson(json['ShortName'] as Map<String, dynamic>),
...
CredentialType _$CredentialTypeFromJson(Map<String, dynamic> json) {
  return CredentialType(
    ...
    backgroundGradientStart:
        _fromColorCode(json['BackgroundGradientStart'] as String),
    backgroundGradientEnd:
        _fromColorCode(json['BackgroundGradientEnd'] as String),
