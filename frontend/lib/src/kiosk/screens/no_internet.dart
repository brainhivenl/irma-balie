                    ...
                    children: <TextSpan>[
                      TextSpan(
                        text: FlutterI18n.translate(
                            context, 'kiosk.no_internet.body2'),
                      ),
                      TextSpan(
                        text: FlutterI18n.translate(
                            context, 'kiosk.no_internet.bullet1'),
                      ),
                      TextSpan(
                        text: FlutterI18n.translate(
                            context, 'kiosk.no_internet.bullet1_bold'),
                        style: IrmaTheme.of(context)
                            .kioskBodyHigh
                            .copyWith(fontWeight: FontWeight.bold),
                      ),
                      ...
                      TextSpan(
                        text: FlutterI18n.translate(
                            context, 'kiosk.no_internet.bullet2'),
                      ),
                      TextSpan(
                        text: FlutterI18n.translate(
                            context, 'kiosk.no_internet.bullet2_bold'),
                        style: IrmaTheme.of(context)
                            .kioskBodyHigh
                            .copyWith(fontWeight: FontWeight.bold),
                      ),
